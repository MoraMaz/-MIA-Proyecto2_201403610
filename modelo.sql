...
DROP SEQUENCE ID_COLOR_SEQ;
DROP SEQUENCE ID_CONVERSACION_SEQ;
...
CREATE TABLE A_TIPO_USUARIO (
	ID_TIPO INTEGER NOT NULL, --0:Administrador 1:HelpDesk 2:Cliente
...
ALTER TABLE A_DETALLE 
	ADD CONSTRAINT DETALLE_DEL_CARRITO_FK 
		FOREIGN KEY (NO_FACTURA) REFERENCES A_FACTURA (NO_FACTURA);
ALTER TABLE A_DETALLE 
...
CREATE SEQUENCE ID_CATEGORIA_SEQ
	START WITH 1
		INCREMENT BY 1;
CREATE SEQUENCE ID_COLOR_SEQ
	START WITH 1
		INCREMENT BY 1;
CREATE SEQUENCE ID_CONVERSACION_SEQ
	START WITH 1
		INCREMENT BY 1;
